        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false, comment: "The description of the product"),
                    Brand = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "The brand name"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "The price of the product"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Foreign key from Category")
                },
                constraints: table =>
                {
